...
spark = SparkSession.builder.appName("TestStreaming").getOrCreate()
...
query = df \
	...
	.format("parquet") \
	.outputMode("append") \
	.option("path", "hdfs://namenode:9000/Data/data") \
	.option("checkpointLocation", "hdfs://namenode:9000/Data/data/checkpoint") \
	.start()
